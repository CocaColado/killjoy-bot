export const CATEGORY_META = {
  duelists: { label: 'Duelistas', emoji: '⚔️', color: 0xff4655 },
  controllers: { label: 'Controladores', emoji: '☁️', color: 0x8b5cf6 },
  initiators: { label: 'Iniciadores', emoji: '🧠', color: 0x3b82f6 },
  sentinels: { label: 'Sentinelas', emoji: '🛡️', color: 0xfacc15 }
};
